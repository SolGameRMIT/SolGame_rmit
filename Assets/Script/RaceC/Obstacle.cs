...
public class Obstacle : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            //print("hit bomb");
            droidStatus.HitObstacle(this.gameObject); // Using "this" is actually unnecessary here, I just think it improves readability
        }
        //else if (other.gameObject.name == "Bolt Bullet")
        //{
        //    droidStatus.ShootObstacle(this.gameObject);
